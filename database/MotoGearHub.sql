...
INSERT INTO Prodotto (IdProdotto, Marca,Image, Prezzo,Nome, Descrizione, IdCategoria) VALUES
(1, 'Alpinestars','product-1.jpg', 999.95, 'ALPINESTARS SUPERTECH R10', 'Casco Integrale in Fibra della ALPINESTARS Modello SUPERTECH R10', 3),
(2, 'Dainese','product-2.jpg' ,309.95, 'DAINESE VR46 DAEMON-X SAFETY HOODIE FULL ZIP', 'Felpa Dainese in morbido tessuto con protezioni morbide Pro-Shape 2.0', 4),
(3, 'Raven','product-3.jpg' ,219.99, 'RAVEN JEANS', 'Jeans atletici slim fit con protezioni premium CE Livello 2', 4),
(4, 'Alpinestars','product-4.jpg',599.95, 'ALPINESTARS GP FORCE PHANTOM', 'La tuta in pelle GP Force Phantom è realizzata in pelle bovina per una resistenza senza limiti!', 4),
(5, 'Mototecnica','product-5.jpg',180.00, 'STIVALI MOTOTECNICA', 'Stivali Touring impermeabili e confortevoli, con protezioni integrate, suola in gomma antiscivolo e chiusura con velcro regolabile.', 1),
(6,'Alpinestars','product-6.jpg',179.00,'ALPINESTARS GUANTI MOTO IN PELLE GP PLUS R V2 NERO/ROSSO FLUO','Guanti in ecopelle Alpinestars Neri/Rossi Fluo',5),
(7,'Dainese','product-7.jpg',209.95,'GIUBBOTTO GIACCA MOTO DAINESE AVRO D2','La giacca Dainese Avro D2 Tex dal look aggressivo è realizzata in tessuto leggero D-Synth 350 con inserti Microelastic per una vestibilità confortevole ed ideale per la guida in moto',4),
